...
async def show_referral_info(callback: CallbackQuery):
    ...
    try:
        ...
        earned_rub = 0
        # 10% от общей суммы подписок рефералов
        total_rub = int(total_referral_subscriptions * 0.1)
    ...
    referral_text = (
        ...
        "Приглашайте друзей и получайте <b>10% с каждой подписки</b> ваших рефералов!\n\n"
        "📊 <b>Ваша статистика:</b>\n"
        ...
        "• При покупке подписки вы получаете 10% от суммы (вывести их можно после набора 10% баллов другом)\n\n"
